...
const Blackjack = () =>
{
    ...
    const displayPlayerHand = () =>
    {
        ...
        document.getElementById("bljk").value = "Your Cards: ";
    ...
    const displayDealerHand = () =>
    {
        ...
        document.getElementById("bljk").value = "Dealer's First Card: ";
    ...
    const displayDealerHandEnd = () =>
    {
        ...
        document.getElementById("bljk").value = "Dealer's Cards: ";
    ...
    const stay = (deck, playersCards, dealersCards) =>
    {
        ...
        if(playerScore > 21)
        {
            ...
            document.getElementById("bljk").value = "Your Score: " + playerScore;
            displayPlayerHand();
            document.getElementById("bljk").value = "Dealer's Score: " + dealerScore;
