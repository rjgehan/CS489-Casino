...
const Login = ({ onLogin }) => {
  ...
  return (
    <body className="login-body">
      ...
      <p>
        <br></br><header className="login-title">CRYPTO CASINO README</header><br></br>
        <br></br><header className="login-header">Juliana Merlino, Peter Pressley, Ryan Gehan, and Kelly Reynolds
...
Website : https://ryangehan.github.io/CS489-Casino/</header>
<br></br>
        <br></br>
      </p>
    </body>
